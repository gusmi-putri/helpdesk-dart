...
const UserDeleteModal: React.FC<UserDeleteModalProps> = ({ isOpen, onClose, onConfirm, user }) => {
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
      <div className="bg-slate-50 dark:bg-gunmetal border-2 border-targetred w-full max-w-sm shadow-[0_0_50px_rgba(200,30,30,0.4)] animate-in zoom-in-95 duration-200">
