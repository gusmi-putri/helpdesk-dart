        ...
        <nav className="flex-1 overflow-y-auto custom-scrollbar py-6 space-y-1">
          <button
            ...
            className={`w-full flex items-center gap-3 px-6 py-4 font-tactical text-sm tracking-wider transition-all border-l-4
              ${activeMenu === 'ANALYTICS' ? 'bg-slate-50 dark:bg-navy/80 text-targetred border-targetred shadow-inner' : 'border-transparent text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-gunmetal/20'}
            `}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-6 py-4 font-tactical text-sm tracking-wider transition-all border-l-4
              ${activeMenu === 'USERS' ? 'bg-slate-50 dark:bg-navy/80 text-targetred border-targetred shadow-inner' : 'border-transparent text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-gunmetal/20'}
            `}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-6 py-4 font-tactical text-sm tracking-wider transition-all border-l-4
              ${activeMenu === 'UNITS' ? 'bg-slate-50 dark:bg-navy/80 text-targetred border-targetred shadow-inner' : 'border-transparent text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-gunmetal/20'}
            `}
          >
          ...
          <div className="mt-4">
            <button
              ...
              className={`w-full flex items-center justify-between px-6 py-4 font-tactical text-sm tracking-wider transition-all border-l-4
                ${activeMenu === 'REPORTS' ? 'bg-slate-50 dark:bg-navy/80 text-targetred border-targetred' : 'border-transparent text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-gunmetal/20'}
              `}
            >
            ...
            {isReportsExpanded && (
              <div className="bg-slate-50 dark:bg-navy/20 py-2 border-l-4 border-targetred/20">
                <button
                  onClick={() => { handleMenuClick('REPORTS'); setActiveSubReport('KERUSAKAN'); }}
                  className={`w-full text-left pl-14 py-2 text-xs font-tactical tracking-widest transition-colors ${activeMenu === 'REPORTS' && activeSubReport === 'KERUSAKAN' ? 'text-targetred font-bold' : 'text-slate-500 dark:text-slate-300 hover:text-targetred'}`}
                >
                  » KERUSAKAN
                </button>
                <button
                  onClick={() => { handleMenuClick('REPORTS'); setActiveSubReport('PERBAIKAN'); }}
                  className={`w-full text-left pl-14 py-2 text-xs font-tactical tracking-widest transition-colors ${activeMenu === 'REPORTS' && activeSubReport === 'PERBAIKAN' ? 'text-targetred font-bold' : 'text-slate-500 dark:text-slate-300 hover:text-targetred'}`}
                >
                  » PERBAIKAN
                </button>
              </div>
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-6 py-4 font-tactical text-sm tracking-wider transition-all border-l-4 mt-4
              ${activeMenu === 'APPROVAL' ? 'bg-slate-50 dark:bg-navy/80 text-targetred border-targetred shadow-inner' : 'border-transparent text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-gunmetal/20'}
            `}
          >
            <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-6 py-4 font-tactical text-sm tracking-wider transition-all border-l-4
              ${activeMenu === 'FEEDBACK' ? 'bg-slate-50 dark:bg-navy/80 text-targetred border-targetred shadow-inner' : 'border-transparent text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-gunmetal/20'}
            `}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-6 py-4 font-tactical text-sm tracking-wider transition-all border-l-4
              ${activeMenu === 'LOGS' ? 'bg-slate-50 dark:bg-navy/80 text-targetred border-targetred shadow-inner' : 'border-transparent text-slate-600 dark:text-slate-300 hover:bg-white dark:hover:bg-gunmetal/20'}
            `}
          >
