      ...
      <div className="space-y-8">
        ...
        <div className="p-6 bg-slate-900 dark:bg-cighra-gold/5 border border-slate-700 dark:border-cighra-gold/20 flex items-center gap-5 relative overflow-hidden mt-8">
           ...
           <div>
              ...
              <p className="font-mono text-xs text-slate-400 dark:text-slate-400 mt-1 tracking-widest">THERE ARE <span className="text-white font-bold">{pendingCases.length} ACTIVE CASES</span> REQUIRING TECHNICAL INTERVENTION IN THIS SECTOR.</p>
           </div>
        </div>
      </div>
    </Modal>
