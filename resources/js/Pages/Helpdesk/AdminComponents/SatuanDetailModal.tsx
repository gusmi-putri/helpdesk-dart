      ...
      <div className="space-y-8">
        ...
        <div className="pb-8 border-b border-slate-200 dark:border-slate-800 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="text-center md:text-left space-y-2">
            <p className="text-xs font-mono text-slate-500 tracking-[0.3em] font-bold uppercase">ID: {satuan.id}</p>
            <h4 className="text-2xl font-tactical font-extrabold text-slate-800 dark:text-white uppercase tracking-wider leading-none">{satuan.nama_satuan}</h4>
            <div className="inline-block bg-cighra-primary/10 dark:bg-cighra-gold/10 border border-cighra-primary/30 dark:border-cighra-gold/30 px-3 py-1 font-mono font-bold text-xs tracking-widest text-cighra-primary dark:text-cighra-gold">
        ...
        <div className="space-y-4">
          <h5 className="text-xs font-mono font-bold text-slate-500 uppercase tracking-widest border-l-2 border-cighra-gold pl-2">ASSET CAPACITY SUMMARY</h5>
        ...
        <div className="p-6 bg-slate-900 dark:bg-cighra-gold/5 border border-slate-700 dark:border-cighra-gold/20 flex flex-col justify-center relative overflow-hidden mt-8">
          <div className="absolute top-0 right-0 w-24 h-24 bg-cighra-gold opacity-[0.03] rotate-45 translate-x-12 -translate-y-12"></div>
          <div>
            <p className="font-tactical font-bold text-white dark:text-cighra-gold uppercase tracking-[0.2em]">LAPORAN KASUS TERTUNDA</p>
            <p className="font-mono text-xs text-slate-400 dark:text-slate-400 mt-1 tracking-widest">TERDAPAT <span className="text-white font-bold">{pendingCases.length} KASUS AKTIF</span> YANG MEMBUTUHKAN PENANGANAN TEKNIS PADA SATUAN INI.</p>
          </div>
        </div>
      </div>
    </BaseModal>
