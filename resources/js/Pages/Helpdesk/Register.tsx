...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-gunmetal relative overflow-hidden font-sans w-full py-12 px-4 selection:bg-olive selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-2xl bg-white/95 dark:bg-navy/95 backdrop-blur-xl border-x border-b border-olive/20 shadow-2xl rounded-sm overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 pb-6 border-b border-olive/10">
            ...
            <Link href="/login" className="flex items-center gap-2 px-4 py-2 border border-slate-300 dark:border-slate-600 hover:bg-olive hover:text-white transition-all duration-300 text-[10px] font-mono font-bold uppercase tracking-widest text-slate-600 dark:text-slate-300">
                ...
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    <input
                      ...
                      className={`w-full bg-soft-sand/30 dark:bg-gunmetal/50 border ${errors.username ? 'border-targetred' : 'border-olive/40 dark:border-olive/60'} group-hover:border-camogreen focus:border-camogreen text-slate-800 dark:text-white px-4 py-3 focus:outline-none transition-all font-mono text-sm rounded-sm`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    <input
                      ...
                      className={`w-full bg-soft-sand/30 dark:bg-gunmetal/50 border ${errors.email ? 'border-targetred' : 'border-olive/40 dark:border-olive/60'} group-hover:border-camogreen focus:border-camogreen text-slate-800 dark:text-white px-4 py-3 focus:outline-none transition-all font-mono text-sm rounded-sm`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    <input
                      ...
                      className={`w-full bg-soft-sand/30 dark:bg-gunmetal/50 border ${errors.nama_lengkap ? 'border-targetred' : 'border-olive/40 dark:border-olive/60'} group-hover:border-camogreen focus:border-camogreen text-slate-800 dark:text-white px-4 py-3 focus:outline-none transition-all font-mono text-sm rounded-sm`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    <input
                      ...
                      maxLength={20}
                      className={`w-full bg-soft-sand/30 dark:bg-gunmetal/50 border ${errors.nrp_nip ? 'border-targetred' : 'border-olive/40 dark:border-olive/60'} group-hover:border-camogreen focus:border-camogreen text-slate-800 dark:text-white px-4 py-3 focus:outline-none transition-all font-mono text-sm rounded-sm`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    <input
                      ...
                      className={`w-full bg-soft-sand/30 dark:bg-gunmetal/50 border ${errors.asal_satuan ? 'border-targetred' : 'border-olive/40 dark:border-olive/60'} group-hover:border-camogreen focus:border-camogreen text-slate-800 dark:text-white px-4 py-3 focus:outline-none transition-all font-mono text-sm rounded-sm`}
