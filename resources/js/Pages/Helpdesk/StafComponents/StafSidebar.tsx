          ...
          {isDataMasterExpanded && (
            <div className="bg-slate-50 dark:bg-cighra-darkcard/20 py-1 border-l-4 border-cighra-primary dark:border-cighra-gold/20">
              <button
                ...
                className={`w-full text-left pl-[54px] py-2.5 flex items-center gap-2 text-xs font-tactical tracking-widest transition-colors ${activeMenu === 'PERSONEL' ? 'text-cighra-primary dark:text-cighra-gold font-bold' : 'text-slate-500 dark:text-slate-300 hover:text-cighra-primary dark:hover:text-cighra-gold'}`}
              >
                <Users size={14} /> » PERSONEL
              </button>
              <button
                onClick={() => { setActiveMenu('INVENTARIS'); setIsMobileMenuOpen(false); }}
                className={`w-full text-left pl-[54px] py-2.5 flex items-center gap-2 text-xs font-tactical tracking-widest transition-colors ${activeMenu === 'INVENTARIS' ? 'text-cighra-primary dark:text-cighra-gold font-bold' : 'text-slate-500 dark:text-slate-300 hover:text-cighra-primary dark:hover:text-cighra-gold'}`}
              >
              ...
              >
                <div className="flex items-center gap-2 truncate">
                  <GitPullRequest size={14} /> » MUTASI INVENTARIS
                </div>
                {mutationPendingCount > 0 && (
