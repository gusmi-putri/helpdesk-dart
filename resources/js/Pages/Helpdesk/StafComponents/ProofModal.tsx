...
const ProofModal: React.FC<ProofModalProps> = ({ isOpen, onClose, viewingProof }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
      <div className="bg-slate-50 dark:bg-gunmetal border-2 border-olive w-full max-w-2xl shadow-2xl animate-in zoom-in-95">
        <div className="p-4 border-b border-olive bg-olive/10 flex justify-between items-center">
          ...
          <button onClick={onClose} className="text-slate-500 hover:text-targetred transition-colors font-bold text-xl">✕</button>
        </div>
        <div className="p-6">
