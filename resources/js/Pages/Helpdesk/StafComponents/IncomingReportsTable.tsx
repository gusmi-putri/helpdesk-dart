  ...
  return (
    <div className="animate-in fade-in space-y-6 mt-6">
      <div className="flex gap-4">
        <div className="bg-white dark:bg-navy/80 border border-targetred p-4 flex-1 shadow-md">
        ...
        <div className="bg-white dark:bg-navy/80 border border-blue-600 p-4 flex-1 shadow-md">
      ...
      <div className="bg-white/60 dark:bg-navy/70 border border-slate-300 dark:border-slate-600 rounded-sm overflow-hidden shadow-xl">
        <div className="p-4 border-b border-slate-200 dark:border-slate-700 bg-gunmetal flex items-center justify-between text-white">
                ...
                <tr key={report.db_id} className="hover:bg-gray-200 dark:hover:bg-slate-700/30 transition-colors text-slate-800 dark:text-white">
                  <td className="p-4">
                    <button
                      ...
                      className="font-mono font-bold text-sm bg-white dark:bg-navy px-2 py-1 border border-slate-300 dark:border-slate-600 block text-center w-fit hover:border-olive hover:text-olive transition-colors group/tid"
                    >
                      {report.caseId}
                    </button>
                  </td>
                  ...
                  <td className="p-4 text-center">
                    {report.status === 'PENDING' ? (
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          {report.kerusakan.fileBukti && report.kerusakan.fileBukti.length > 0 && (
                            <button
                              ...
                              className="w-full bg-white dark:bg-navy/80 hover:bg-slate-50 dark:hover:bg-black text-slate-600 dark:text-slate-300 px-3 py-1.5 text-[10px] font-mono font-bold tracking-widest transition-colors flex items-center justify-center gap-2 border border-slate-300 dark:border-slate-600"
                            >
                      ...
                      <div className="text-slate-500 dark:text-slate-300 text-[10px] font-mono border border-slate-200 dark:border-slate-700 p-2 bg-slate-50 dark:bg-navy/80">
