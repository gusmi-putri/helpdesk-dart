      ...
      <div className="bg-slate-50 dark:bg-gunmetal border-2 border-targetred w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
                ...
                <button
                  ...
                  className={`p-3 border-2 transition-all flex flex-col items-center justify-center gap-1
                    ${recapPeriod === period 
                      ...
                      : 'border-slate-300 dark:border-slate-600 text-slate-500 dark:text-slate-400 hover:border-targetred/30'}
                  `}
                >
            ...
            {recapPeriod === 'custom' && (
              <div className="grid grid-cols-2 gap-3 p-4 bg-slate-50 dark:bg-navy/30 border border-targetred/30 animate-in slide-in-from-top-2">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white dark:bg-navy border border-slate-300 dark:border-slate-600 p-2 text-xs font-mono outline-none focus:border-targetred text-slate-800 dark:text-white"
                  />
                </div>
                <div>
            ...
            {recapPeriod === 'year_specific' && (
              <div className="p-4 bg-slate-50 dark:bg-navy/30 border border-targetred/30 animate-in slide-in-from-top-2">
