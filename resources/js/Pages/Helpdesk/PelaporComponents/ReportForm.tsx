  ...
  if (userUnits.length === 0) {
    return (
      <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
        <div className="glass-panel p-10 text-center border-t-4 border-t-cighra-gold dark:border-t-cighra-gold !bg-cighra-primary dark:!bg-cighra-darkcard/80 shadow-xl flex flex-col items-center justify-center min-h-[400px]">
          <Package className="w-20 h-20 text-slate-300 dark:text-slate-400 mb-6" />
          <h2 className="text-2xl font-tactical font-bold text-white tracking-wider uppercase mb-4">
            SATUAN BELUM MEMILIKI DATA UNIT
          </h2>
          <p className="text-sm text-slate-200 dark:text-slate-300 max-w-md mx-auto leading-relaxed mb-6">
          ...
          <div className="flex gap-4">
            <a href="https://wa.me/6282225418071" target="_blank" className="flex items-center gap-2 px-6 py-3 bg-cighra-gold hover:bg-cighra-gold/90 text-slate-900 font-tactical font-bold tracking-widest text-xs transition-all shadow-lg rounded-sm">
