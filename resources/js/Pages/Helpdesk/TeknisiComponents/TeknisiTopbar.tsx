        ...
        <Menu as="div" className="relative ml-auto">
          ...
          >
            <div className="bg-cighra-dark/40 dark:bg-cighra-darkcard/80 px-4 py-1.5 text-right flex flex-col justify-center border-r border-slate-200/20 dark:border-slate-600">
              <span className="block text-xs font-bold text-white dark:text-white uppercase font-sans tracking-wider">{currentUser?.name || currentUser?.nama_lengkap || 'Teknisi DART'}</span>
              <span className="block text-[11px] font-mono tracking-widest text-cighra-gold dark:text-cighra-gold uppercase">{currentUser?.role?.nama_role || currentUser?.role || 'TEKNISI'}</span>
            </div>
