...
const Features = () => {
  ...
  return (
    <section id="aset" className="py-24 bg-slate-50 dark:bg-gunmetal relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {assets.map((asset, index) => (
            ...
            >
              ...
              <p className="text-sm text-slate-500 dark:text-slate-500 font-sans border-t border-slate-200 dark:border-slate-700 pt-4">{asset.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
