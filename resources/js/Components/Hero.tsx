...
const Hero = () => {
  return (
    <section id="beranda" className="relative min-h-screen pt-16 flex items-center justify-center overflow-hidden bg-cighra-light dark:bg-cighra-dark">
      {/* Background Overlay */}
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto py-8">
        ...
        >
          <img src="/logo.png" fetchPriority="high" loading="eager" className="w-18 h-18 sm:w-20 sm:h-20 object-contain animate-pulse" alt="Logo" />
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl md:text-6xl font-stencil font-bold text-slate-800 dark:text-white mb-4 tracking-wider uppercase leading-tight"
        >
        ...
        <motion.p
          ...
          className="font-mono text-xs md:text-sm tracking-[0.25em] text-cighra-primary font-bold drop-shadow-sm dark:font-normal dark:text-slate-400 uppercase mb-6"
        >
        ...
        >
          <Link href="/login" className="px-6 py-3.5 bg-cighra-primary dark:bg-cighra-gold dark:text-slate-900 hover:bg-cighra-primary/95 dark:hover:bg-cighra-gold/95 text-white font-tactical font-bold text-sm tracking-widest uppercase transition-all tactical-border border-cighra-gold shadow-lg hover:shadow-[0_0_20px_rgba(30,49,102,0.4)] dark:hover:shadow-[0_0_20px_rgba(230,194,31,0.4)] text-center">
            Buat Laporan Baru
          </Link>
          <a href="#PANDUAN" className="px-6 py-3.5 bg-transparent border-2 border-cighra-gold hover:bg-cighra-primary dark:hover:bg-cighra-gold hover:text-white dark:hover:text-slate-900 text-slate-800 dark:text-white font-tactical font-bold text-sm tracking-widest uppercase transition-all text-center">
            Lihat Panduan
          </a>
        </motion.div>
      </div>
